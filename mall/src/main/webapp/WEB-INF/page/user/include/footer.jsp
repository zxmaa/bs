...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/res/css/user/fore_foot.css"/>
    <link href="${pageContext.request.contextPath}/res/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
<div class="container-fluid" id="foot_container">
    <%--<div class="footer-copyright">--%>
        ...
        <div class="row">
            ...
            <%--<div class="copyright">--%>
                ...
                <a href="#" target="_blank" class="link_normal">关于我们</a>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;你知道什么是996.ICU吗？</span>
                <a href="https://996.icu"><img src="https://img.shields.io/badge/link-996.icu-red.svg" alt="996.icu"/></a>
                <br/>
                <span style="font-weight: bold;">声明：此项目为毕业设计</span>
                <br/>
                <a href="http://www.xhu.edu.cn/" target="_blank" style="text-align: center;display: block;">
                    <img src="${pageContext.request.contextPath}/res/img/user/WebsiteImage/TB1yEqRPXXXXXXPXpXXXXXXXXXX-20-20.png" alt="西华大学">
                    西华大学
                </a>
            </div>
        </div>
