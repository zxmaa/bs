    ...
    <div class="nav_main">
        ...
        <ul class="quick_li"><%-- 快捷菜单 --%>
            ...
            <li class="quick_li_cart">
                <img src="${pageContext.request.contextPath}/res/img/user/WebsiteImage/buyCar.png" alt="购物车">
            ...
            <li class="quick_li_mobile">
                <img src="${pageContext.request.contextPath}/res/img/user/WebsiteImage/mobile.png" alt="手机版">
                <a href="#" title="天猫无线">手机版</a>
                <div class="quick_qrcode">
                    <img src="${pageContext.request.contextPath}/res/img/user/WebsiteImage/qrcode.png"alt="">
                    <b></b>
                </div>
            </li>
